...
public class User {
	...
	@Override
	public int hashCode() {
		return Objects.hash(created_time, email, full_Name, id, password, phone_no);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		User other = (User) obj;
		return Objects.equals(created_time, other.created_time) && Objects.equals(email, other.email)
				&& Objects.equals(full_Name, other.full_Name) && id == other.id
